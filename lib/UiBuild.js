...
class UiBuild {
  constructor({AppRef, isDev, buildDir}) {
    ...
    this.hbsPluginUi = path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/**/*.hbs');
    this.lessAppUi = path.join(this.workspaceDir, 'adapt-authoring-ui/app/**/*.less');
    this.lessPluginUi = path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/**/*.less');
    ...
    this.jsPluginUi = path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/**/*.js');
    this.jsxPluginUi = path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/**/*.jsx');
    ...
    this.assetsPaths = [
      ...
      path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/**/assets/**')
    ]
    ...
    this.librariesPaths = [
      ...
      path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/libraries/**/*')
    ];
    ...
    this.requiredPaths = [
      ...
      path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/required/**/*')
    ];
  ...
  async copyAssets() {
    ...
    const pluginAssets = await glob(path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/**/assets/**'));
  ...
  async copyLibraries() {
    ...
    const pluginDirs = await glob(path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/libraries'), {onlyDirectories: true});
  ...
  async copyRequired() {
    ...
    const pluginDirs = await glob(path.join(this.workspaceDir, 'adapt-authoring-*/ui-plugins/required'), {onlyDirectories: true});
  ...
  async compileLess() {
    ...
    const lessPluginUi = await globPromise('adapt-authoring-*/ui-plugins/**/*.less', { cwd: this.workspaceDir, nodir: true, absolute: true });
  ...
  async run() {
    try {
      ...
      if(App.instance.args.w || App.instance.args.watch) {
