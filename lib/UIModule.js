 ...
 */
export default class UIModule extends AbstractModule {
  /** @override */
  async init() {
     ...
     * @type {String}
     */
    this.rootDir = new URL('..', import.meta.url).pathname;
    /**
  ...
  servePage(pageName) {
    return (req, res, next) => {
      res.render(new URL(`../app/core/${pageName}`, import.meta.url).pathname, this.indexData);
    }
  }
}