    ...
    this.options = {
      ...
      external: {
        ...
        'polyglot': 'empty:'/*,
         ...
         add Node dependencies here e.g:

        'react-organizational-chart': 'node_modules:',
        '@emotion/styled': 'node_modules:'

        TODO: for ui-plugins these should be pulled dynamically from the respective package.json files
        */
      },
      externalMap:{},
      map:{
