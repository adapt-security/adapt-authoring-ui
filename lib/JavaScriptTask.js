...
export default class JavaScriptTask {
  ...
  constructor(buildDir, logFunc) {
    ...
    const packagesWithUiPlugin = globSync('node_modules/adapt-authoring-*/ui-plugins/')
  ...
  async run() {
    ...
    const pluginsObject = {
      plugins: [
        ...
        assume entry point is ui-plugins/[DIR]/index.js
        {
          "name": "revisions",
          "main": "index.js",
          "sourcePath": "node_modules/adapt-authoring-vcs-course/ui-plugins/revisions"
        }
        ...rest of plugins
        */
      ]
